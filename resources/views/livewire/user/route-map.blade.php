                ...
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <button class="btn btn-outline-secondary btn-sm" 
                                wire:click="refreshRealTimeStatus">
                            <i class="fas fa-refresh me-1"></i>刷新狀態
                        </button>
                        
                        <button class="btn btn-warning btn-sm" 
                                wire:click="autoSync" 
                                wire:loading.attr="disabled">
                            <i class="fas fa-magic me-1"></i>自動同步
                        </button>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-3">
                                <div class="text-center border rounded p-2">
                                    <h5 class="text-success mb-1">
                                        {{ count($gpsPoints) > 0 ? \Carbon\Carbon::parse($gpsPoints[0]['time'])->format('H:i:s') : '--' }}
                                    </h5>
                                    <small class="text-muted">開始時間</small>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="text-center border rounded p-2">
